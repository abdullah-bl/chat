...
import { Send, Sparkles, Loader2, Bot, User, Zap, Trash2, AlertCircle } from "lucide-react";
        ...
        <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] px-2 py-0.5 bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-300 rounded-full font-medium">
                        Transformers.js
                    </span>
                </div>
                <div className="flex items-center gap-2">
                ...
                {messages.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center px-6 text-center">
                        ...
                        <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-6 max-w-sm">
                            Runs {useAgentStore.getState().modelId.split("/").pop()} entirely in your browser.
                            No server, no API key — pure WebAssembly.
                        </p>
                        ...
                        {isReady && (
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-neutral-400">Type a message below to start</p>
                            </div>
                        )}
            ...
            <form onSubmit={handleSubmit} className="flex items-end gap-2 p-3 border-t border-neutral-200 dark:border-neutral-800">
                <textarea
                    ...
                    placeholder={isReady ? "Message the agent..." : "Initialize model first..."}
